...
{
  "id": 25,
  "question": "JavaScript: Declare a variable with let\n\n__________ age = 25;",
...
{
  "id": 30,
  "question": "Node.js: Require Express Module\n\nconst express = __________(\"express\");",
