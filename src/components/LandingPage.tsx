        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">LASAK Technology</h1>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-gray-50 to-blue-50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h4 className="text-2xl font-semibold text-gray-900 mb-4">Pioneering Digital Assessment Solutions</h4>
              <p className="text-gray-600 mb-6 leading-relaxed">
                LASAK Technology is at the forefront of educational technology, providing innovative digital assessment platforms 
                that transform how examinations are conducted and evaluated. Our mission is to make testing more accessible, 
                secure, and insightful for educational institutions worldwide.
              </p>
